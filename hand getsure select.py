...
while True:
    ...
    if frame_count % FRAME_SKIP == 0:
        ...
        if result.multi_hand_landmarks:
            for hand_landmarks in result.multi_hand_landmarks:
                ...
                for id, lm in enumerate(hand_landmarks.landmark):
                    ...
                    if id == 16: #Wrist
                        ring_finger_tip = (x,y)
                #logic of click with thumb and index
        ...
        #scrolling function using middle, index down and middle with thumb up
                if middle_finger_tip and thumb_tip:
                    distance = np.hypot(middle_finger_tip[0] - thumb_tip[0], middle_finger_tip[1] - thumb_tip[1])
                ...
                if index_finger_tip and middle_finger_tip :
                    distance = np.hypot(index_finger_tip[0] - middle_finger_tip[0], index_finger_tip[1] - middle_finger_tip[1])
